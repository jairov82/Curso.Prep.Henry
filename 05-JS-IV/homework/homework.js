...
function crearGato(nombre, edad) {
  ...
  var objeto={
    nombre: nombre,
    edad: edad,
    meow: function gato(){return 'Meow!'}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  // Tu código:
  producto.calcularPrecioDescuento = function(){var precioConDescuento= producto.precio - (producto.precio * producto.porcentajeDeDescuento)
